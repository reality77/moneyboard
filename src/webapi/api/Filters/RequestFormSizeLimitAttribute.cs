    ...
    public class RequestFormSizeLimitAttribute : Attribute, IAuthorizationFilter, IOrderedFilter
    {
        ...
        public RequestFormSizeLimitAttribute(int valueLengthLimit)
        {
            _formOptions = new FormOptions()
            {
                ...
                //ValueCountLimit = valueLengthLimit,
                //MultipartBodyLengthLimit = valueLengthLimit,
                //MultipartHeadersLengthLimit = valueLengthLimit,
                //MultipartBoundaryLengthLimit = valueLengthLimit,
            };
        }
